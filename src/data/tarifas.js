...
const TARIFAS = {
  5000:  ['ASUNCION','FÁTIMA','MIRADOR AZUL','AZULITA PARTE BAJA','CRISTO REY ABAJO DE LA PISCINA','HORIZONTES','MIRAFLORES','MISERICORDIA HASTA PRINCESS','MOJÓN','OBRERO COPACABANA','PEDREGAL PARTE BAJA','PEDRERA','SAN FRANCISCO','SHANGAY','SIMÓN BOLÍVAR','TOBÓN QUINTERO','VEGAS PARTE BAJA','MONTE VERDE','REMANSO','DE LA ASUNCIÓN A LA ASUNCIÓN','YARUMITO PARTE BAJA','CANOAS HASTA LA TIENDA DEL CUSCO','PIEDRAS BLANCAS','PORVENIR','RECREO','DE LA PEDRERA A LA PEDRERA'],
