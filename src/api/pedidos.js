// api/pedidos.js
// GET /api/pedidos?tienda=EXPERTOS — devuelve pedidos de hoy al admin
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const hoy = new Date().toLocaleDateString('es-CO', { day:'2-digit', month:'2-digit', year:'numeric', timeZone:'America/Bogota' });

    const rows = (r.data.values || []).slice(1)
      .filter(r => r[0] && r[13] === hoy) // solo pedidos de hoy
      // filtrar por tienda si se indica (el nombre del negocio en col H contiene "EXPERTOS" o "CENTRAL")
